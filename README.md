...
First attempt at creating a jtex template!

![](thumbnail.png)

- Author: Oliver Hensby (Future of Science Publishing)
- Author Website: https://example.com
- [Submission Guidelines](https://github.com/ollyhensby/mystmd-first-template)
